			...
			for (int k = 0; k < lane_section->GetNumberOfLanes(); k++)
			{
				...
				if ((!lane->IsCenter() && !lane->IsOSIIntersection()))
				{
					...
					if (!osi_lane)
					{
						...
						// printf("Debug in OSIReporter::UpdateOSIRoadLane: Lane ID: ((%i,%i) - %i)\n", road->GetId(), lane->GetId(), lane->GetGlobalId());
						...
						// 	printf("Debug in OSIReporter::UpdateOSIRoadLane: Predecessor Lane ID: ((%i,%i) - %i)\n", predecessorRoad->GetId(), predecessorLane->GetId(), predecessorLane->GetGlobalId());
						// }
						...
						// 	printf("Debug in OSIReporter::UpdateOSIRoadLane: Successor Lane ID: ((%i,%i) - %i)\n", successorRoad->GetId(), successorLane->GetId(), successorLane->GetGlobalId());
						// }
